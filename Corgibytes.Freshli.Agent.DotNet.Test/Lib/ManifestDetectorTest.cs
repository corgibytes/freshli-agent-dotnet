...
public class ManifestDetectorTest
{
    ...
    public void ManifestFinders()
    {
        ...
        Assert.Equal("Corgibytes.Freshli.Agent.DotNet/Corgibytes.Freshli.Agent.DotNet.csproj", manifestFilenames[0]);
        Assert.Equal("Corgibytes.Freshli.Agent.DotNet.Test/Corgibytes.Freshli.Agent.DotNet.Test.csproj", manifestFilenames[1]);
    }
}
